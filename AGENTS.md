...
6. **ห้ามเอ่ยชื่อนิสิตจริงโดย default** — ยกเว้นผลงาน/รางวัล/งานนำเสนอ/สิ่งตีพิมพ์ที่เผยแพร่สาธารณะแล้วและมีสถานะระบุใน input
...
- `/psf-context/style_guide.md` — รูปแบบภาษาไทยวิชาการและ micro-loop ส 2.4
...
4. Micro-loop ส 2.4 = มีกระบวนการประเมินระหว่างเรียน → สิ่งที่พบ → feedback เฉพาะเจาะจง → ผลหลัง feedback หรือไม่?
5. Dimension = ระบุรหัส ร/ส/ค ได้หรือไม่? ใช้ 2 ระดับเป็น default เช่น (ส 2.4)
